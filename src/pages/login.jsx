...
//         <div  className="-mt-[650px] mr-20">
//         <button onClick={handleNavigate} className=" mt-10 font-bold w-20"><FaArrowAltCircleLeft className="w-10 h-10"/></button>
//         </div>
...
//                   <h2 className="text-lg font-bold">If you just want to try features you can use this infoemations given below.</h2>
